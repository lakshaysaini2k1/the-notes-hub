...
<body>
  <nav>
    ...
    <ul id="menuList">
      <li><a href="adminnotes.php"><i class="eye bi-eye"></i>View Notes</a></li>
      <li><a href="upload.php"><i class="cloud-upload bi-cloud-upload "></i>Upload notes</a></li>
      <!-- <li><a href="request.php"><i class="bi-send"></i>User Request</a></li> -->
...
<section >
        ...
        <p class="head">This is an admin page</p>
      </section>
</div>
<div class="container">
  <section >
